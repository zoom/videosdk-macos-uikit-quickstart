...
@property (nonatomic, strong, nullable) NSArray<NSColor *> *normalGradientColors;
@property (nonatomic, strong, nullable) NSArray<NSColor *> *hoverGradientColors;
@property (nonatomic, strong, nullable) NSArray<NSColor *> *pressGradientColors;
@property (nonatomic, strong, nullable) NSArray<NSColor *> *disableGradientColors;
...
- (instancetype)initWithGradientStyle;
+ (instancetype)buttonWithGradientStyle;
