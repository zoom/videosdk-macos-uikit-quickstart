...
FOUNDATION_EXPORT NSString * const ZMUserNotificationThreadIdentifierChat;
FOUNDATION_EXPORT NSString * const ZMUserNotificationThreadIdentifierMail;
FOUNDATION_EXPORT NSString * const ZMUserNotificationThreadIdentifierUpcomingMeetingReminder;
