...
//banner
@property (nonatomic, copy, nullable) NSString  *bannerTitle;
@property (nonatomic, copy, nullable) NSString  *bannerBody;
@property (nonatomic, copy, nullable) NSString  *bannerActionTitle;
@property (nonatomic, copy, nullable) dispatch_block_t bannerAction;
