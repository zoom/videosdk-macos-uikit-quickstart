...
- (void)onPairedUSBAudioDeviceDetected:(const CmmAudioUSBDeviceBriefInfo&)info isDeviceFound:(CmmBool)is_device_found;
...
@interface ZMConfBaseSinkAdapter (ConfUniversalUI)
