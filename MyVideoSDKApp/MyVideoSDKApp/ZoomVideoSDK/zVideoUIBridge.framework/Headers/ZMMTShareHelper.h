...
// Share audio capability - unified interface
- (BOOL)isShareAudioDisabled;
...
//hub consolidation op switch
- (BOOL)isRenameHubEnabled;

//hub banner & badge
- (BOOL)isShowToolbarMorePanelHubBanner;
- (void)dismissToolbarMorePanelHubBanner;
- (BOOL)isShowToolbarMorePanelHubBadge;
- (void)dismissToolbarMorePanelHubBadge;
- (BOOL)isShowSharePanelHubBanner;
- (void)dismissSharePanelHubBanner;
- (BOOL)isShowSharePanelHubBadge;
- (void)dismissSharePanelHubBadge;
- (BOOL)isShowSharePanelBrowserTabBanner;
- (void)dismissSharePanelBrowserTabBanner;
- (BOOL)isShowSharePanelBrowserTabBadge;
- (void)dismissSharePanelBrowserTabBadge;
...
//video quality
- (BOOL)isVideoQualityEnabled;//video quality web option && feature toggle && high FPS machine capability
- (BOOL)isSendingShareSupportFullHD;//fullHD meeting web option
- (BOOL)isSendingShareSupportFullHD60FPS;//high FPS fullHD machine capability
