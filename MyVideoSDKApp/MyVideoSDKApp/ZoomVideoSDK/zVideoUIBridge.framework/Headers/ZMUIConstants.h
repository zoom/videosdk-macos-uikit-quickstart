...
#define ZMLoggingModule_StudioUI  "StudioUI"
...
typedef NS_OPTIONS(NSUInteger, ZMMTContentType){
    ...
    ZMMTContentType_BestFit         = 1ll<<38,
...
typedef NS_OPTIONS(NSUInteger, ZMVideoMenuPlaceID) {
    ZMVideoMenuPlaceID_None   = 0,
    ZMVideoMenuPlaceID_Normal = 1 << 0,
    ZMVideoMenuPlaceID_ASL    = 1 << 1,
    ZMVideoMenuPlaceID_Plist  = 1 << 2,
    ZMVideoMenuPlaceID_VideoTile = 1 << 3,
    ZMVideoMenuPlaceID_BestFit = 1 << 4,
};
