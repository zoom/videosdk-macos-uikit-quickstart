 ...
 * @return If the function succeeds, the return value is @c ZMVideoSDKErrors_Success, otherwise failed. To get extended error information, see \link ZMVideoSDKErrors \endlink.
 */
 ...
 * @param rawdata You can get the YUV data address through this object and then pre-process the data, see \link ZMVideoSDKYUVRawDataI420 \endlink.
 * @param sender Use this object to send the processed data out, see \link ZMVideoSDKSharePreprocessSender \endlink.
 */
 ...
 * @return The share pipe. For more information, see \link ZMVideoSDKRawDataPipe \endlink.
 */
- (ZMVideoSDKRawDataPipe* _Nullable)getSharePipe;

/**
 * @brief Gets the render canvas object.
 * @return If the function succeeds, the return value is the ZMVideoSDKVideoCanvas object. Otherwise this function fails and returns nil, see \link ZMVideoSDKVideoCanvas \endlink.
 */
 ...
 * @return If the function succeeds, it will return the remote control helper object. For more information, see \link ZMVideoSDKRemoteControlHelper \endlink.
 */
 ...
 * @param sender See \link ZMVideoSDKShareSender \endlink.
 */
 ...
 * @param sender See \link ZMVideoSDKShareAudioSender \endlink.
 */
 ...
 * @param shareSource External share source. To get extended error information, see \link ZMVideoSDKShareSource \endlink.
 * @param audioSource External audio source. To get extended error information, see \link ZMVideoSDKShareAudioSource \endlink.
 * @return If the function succeeds, it will return @c ZMVideoSDKErrors_Success. Otherwise failed. To get extended error information, see \link ZMVideoSDKErrors \endlink.
 ...
 * @param audioSource the pointer of external audio source object. To get extended error information, see \link ZMVideoSDKShareAudioSource \endlink.
 * @return If the function succeeds, it will return @c ZMVideoSDKErrors_Success. Otherwise failed. To get extended error information, see \link ZMVideoSDKErrors \endlink.
 ...
 * @note This setting only takes effect for the user's own share, and both displayTime and vanishingTime must not exceed 15000 milliseconds (15 seconds).
 ...
 * @param param The share preprocessing parameters, see \link ZMVideoSDKSharePreprocessParam \endlink.
