...
#import <zm_conf_universal_ui/psl/zm_conf_uui_psl_api.h>
...
#import <zm_conf_universal_ui/zm_conf_uui_best_layout_api.h>
#import <zm_conf_universal_ui/zm_conf_uui_aic_interface.h>
...
using namespace CmmQA;
using namespace CmmChat;
...
- (CmmQA::ICmmQAApi *)getConfInstQAApi;
...
- (ICmmMeetingTranscriptAPI *)getMeetingTranscriptAPI;
...
#pragma mark - AIC
+ (ZUUI::IAicUniversalUi *)getAicUniversalUi;
...
+ (ZUUI::IUuiBestLayoutApi *)getBestLayoutApi;
#pragma mark - Audio
...
+ (ZUUI::IVoiceNotesMeetingProcessUi *)getVoiceNotesMeetingProcessUi;
@end
