...
typedef NS_ENUM(NSUInteger, ZMAlertButtonType) {
    ...
    ZMAlertButtonTypeServiceHub,
    ZMAlertButtonTypeCustom
};
...
// Dismiss timer from CmmZpnsNoticeDismiss.timer (milliseconds)
@property (nonatomic,assign) int64_t dismissTimer;
