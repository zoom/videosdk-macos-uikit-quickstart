...
- (nullable NSArray *)getSelectEmojis;

- (nullable NSArray<NSDictionary *> *)getPanelOrderEmojis;
...
- (BOOL)raiseMySelfHand;

- (BOOL)lowerMySelfHand;

- (BOOL)onLowerHandWithUser:(ZMUser *)zmUser;
