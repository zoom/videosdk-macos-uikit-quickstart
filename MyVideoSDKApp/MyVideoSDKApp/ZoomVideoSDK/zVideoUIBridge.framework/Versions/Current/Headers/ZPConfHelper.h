...
extern ZCV const ZCV6_7_5;
extern ZCV const ZCV7_0_0;
extern ZCV const ZCV7_1_0;
...
- (BOOL)isChatOff;
- (BOOL)isQAOff;
- (BOOL)isQAStreamConflict;
- (BOOL)isMeetingQAEnabled;
...
- (BOOL)needPromptInviteDialogWhenJoinMeeting;
- (void)setInviteDialogPoppedOut;
...
#pragma mark - Main Window Visibility
- (BOOL)mainWindowVisible;
- (BOOL)mainWindowVisibleInSendingShare;
- (BOOL)mainWindowInvisibleInSendingShare;
- (BOOL)enableShowMainWindowWhenSendingShare;

- (int)getLeaveReason;//return CmmLeaveReason

// Common Business Operations (MainConf methods)
- (void)handleConfCmd:(NSInteger)cmd;
- (void)handleUserCmd:(NSInteger)cmd userId:(ZMUserID)userId;
- (void)agreeCommonDisclaimer:(BOOL)agree disclaimerID:(NSString*)disclaimerID;
- (void)agreeStartRecordingDisclaimer:(BOOL)agree;
- (void)agreeZoomPhoneACRDisclaimer;
- (void)suspendMeeting;
- (BOOL)isShareLocked;
- (BOOL)isAllowPanelistVote;
- (void)reportIssue:(NSInteger)issueType;
...
+ (BOOL)isFirstTimeUse:(FirstTimeFlag)flag underVersion:(ZCV)version;
...
- (BOOL)isEnhancedMediaFeatureEnabled;
...
- (BOOL)resumeNotesTranscriptionForUser:(ZMUser *)user;
- (BOOL)stopAllNotesTranscriptions;
- (BOOL)resumeAllNotesTranscriptions;
- (BOOL)isAllNotesTranscriptDisabled;
- (BOOL)isMyNotesTranscriptDisabledForUser:(ZMUser *)user;
- (BOOL)isSupportNotesTranscript;
- (BOOL)isAICRestrictedByExternalUser;
- (BOOL)isMyNotesEnabledForAll;
- (BOOL)isMyNotesEnabled;
- (BOOL)isMyNotesEntranceEnabled;
- (BOOL)isMyNotesStarted;
- (void)onViewMyNotes;
- (BOOL)hasAicLicense;
