...
typedef enum
{
    ...
    /** Cannot call cleanUp while in session. Leave the session before calling cleanUp. */
    ZMVideoSDKErrors_Cannot_Call_Cleanup_In_Session = 7700
}ZMVideoSDKErrors;
...
typedef enum
{
    ...
    ZMVideoSDKStatisticsDirection_Send = 0,
    /** Receiving media statistics. */
    ZMVideoSDKStatisticsDirection_Receive = 1
