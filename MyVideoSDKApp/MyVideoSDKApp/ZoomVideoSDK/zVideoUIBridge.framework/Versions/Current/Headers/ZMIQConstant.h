...
typedef NS_ENUM(NSInteger, ZMActionNeedAicUiDoAfterClick) {
    ZMActionNeedUiDoAfterClickUnknow = 0,
    ZMActionNeedUiDoAfterClickOpenSidePanel,
    ZMActionNeedUiDoAfterClickOpenSidePanelAndRequestStartAic,
    ZMActionNeedUiDoAfterClickOpenSidePanelAndRequestAccessAic,
};
