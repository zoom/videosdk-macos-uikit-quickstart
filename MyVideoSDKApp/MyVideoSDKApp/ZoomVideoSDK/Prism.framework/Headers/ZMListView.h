...
@property (nonatomic, assign) BOOL axAutomaticSelectedRow;
...
@property (nonatomic, assign) BOOL shouldResizeContentInLiveSize;
...
- (void)reloadDataForRowIndexes:(NSIndexSet *)rowIndexes
            relayoutImmediately:(BOOL)relayoutImmediately;
...
- (void)batchInsertItemsAtIndexes:(NSArray <NSIndexSet * >*)indexes inParents:(NSArray *)parents withAnimation:(NSTableViewAnimationOptions)animationOptions;
...
- (void)removeItemsAtIndexes:(nonnull NSIndexSet *)indexes inParent:(nullable id)parent withAnimation:(NSTableViewAnimationOptions)animationOptions relayoutImmediately:(BOOL)relayoutImmediately;
...
@property (nonatomic, strong, nullable) NSLayoutConstraint* zmList_topConstraint;
@property (nonatomic, strong, nullable) NSLayoutConstraint* zmList_leadingConstraint;
@property (nonatomic, strong, nullable) NSLayoutConstraint* zmList_widthConstraint;
@property (nonatomic, strong, nullable) NSLayoutConstraint* zmList_heightConstraint;
@end
