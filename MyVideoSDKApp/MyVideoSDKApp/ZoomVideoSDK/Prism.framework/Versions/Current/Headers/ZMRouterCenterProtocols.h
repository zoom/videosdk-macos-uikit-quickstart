...
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol;
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol sender:(nullable id)sender;
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol sender:(nullable id)sender object:(nullable id)object;
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol sender:(nullable id)sender object:(nullable id)object tag:(NSInteger)tag;
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol sender:(nullable id)sender object:(nullable id)object tag:(NSInteger)tag ignoreSelfObjectIfNil:(BOOL)ignoreSelfObjectIfNil;
- (nullable ZMEventPoster*)posterForProtocol:(Protocol *)protocol callBack:(void(^)(id obj, BOOL returnValue, BOOL *stop))callBack;
@end
...
- (void)enumerateProtocolsAndClassesUsingBlock:(void (NS_NOESCAPE ^)(Protocol *protocol, Class cls, BOOL *stop))block;
