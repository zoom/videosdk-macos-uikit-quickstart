...
#if (((defined WIN_ZOOMAPP) || (defined __MACOS__) || (defined ENABLE_ANDROID_CLIENT_ZAPP) || (defined __IOS__ && !defined(__WATCHOS__)) || (defined __LINUX_CLIENT__ && !defined BUILD_FOR_CLIENT_SDK)) && (!defined BUILD_FOR_MIMO) && (!defined BUILD_FOR_ZPCONTROLLER))
#ifndef ENABLE_ZAPP
    #define ENABLE_ZAPP
#endif
#endif
...
#if (((defined __IOS__ && !defined(__WATCHOS__)) || (defined CMM_ANDROID) || (defined WIN_CCI) || (defined __MACOS__) || (defined __LINUX_CLIENT__ && !defined BUILD_FOR_CLIENT_SDK)) && (!defined BUILD_FOR_MIMO))
...
#if ((defined WIN_Calendar) || (defined __MACOS__) || (defined ENABLE_ANDROID_CLIENT_ZCALENDAR) || (defined(__IOS__) && !defined(__WATCHOS__)) || (defined __LINUX_CLIENT__ && !defined BUILD_FOR_CLIENT_SDK)) ||  (defined BUILD_FOR_MIMO) || (defined BUILD_FOR_ZPCONTROLLER)
...
#if (((defined WIN_MailClient) || (defined __MACOS__) || (defined ENABLE_ANDROID_CLIENT_ZMAIL) || (defined __IOS__ && !defined(__WATCHOS__)) || (defined __LINUX_CLIENT__ && !defined BUILD_FOR_CLIENT_SDK)) && (!defined BUILD_FOR_MIMO) && (!defined BUILD_FOR_ZPCONTROLLER))
...
#if (defined ( _WIN32 ) || defined ( __WIN32__ ) || defined ( WIN32 ) || defined _M_ARM64) && defined(BUILD_FOR_ZPCONTROLLER)
#define BUILD_FOR_WIN_ZPCONTROLLER
#endif

#if !defined(BUILD_FOR_LITE_SDK) && !defined(BUILD_FOR_MINIPACKAGE) && !defined(BUILD_FOR_WIN_ZPCONTROLLER)
...
#if defined(WIN32) || defined(__MACOS__) || defined(__LINUX_CLIENT__)
...
// Async proxy resolution feature - only available on Windows and Mac
// where ZoomProxy library is linked
#define FEATURE_ASYNC_PROXY_RESOLVE
#endif
#endif
...
#if ((defined CMM_WIN) && (defined BUILD_FOR_NORMAL_CLIENT)) || (defined BUILD_FOR_VDI)
#define ENABLE_POWER_SAVER_MODE
#endif

#if ((defined CMM_WIN) || (defined __MACOS__) || (defined __IOS__)) && (defined BUILD_FOR_NORMAL_CLIENT)
...
#if (defined CMM_WIN) && !defined(BUILD_FOR_MIMO) && !defined(BUILD_FOR_ZPCONTROLLER)
#define ENABLE_ONDEMAND_COMPONENT_DOWNLOAD
#endif

#if (defined CMM_WIN) && (!defined BUILD_FOR_MIMO) && (!defined BUILD_FOR_ZPCONTROLLER)
#define ENABLE_WIN_ONE_RENDER
#endif

#if (defined BUILD_FOR_CLIENT_SDK) || ((defined (CMM_WIN) || defined(__MACOS__) || defined(__LINUX_CLIENT__)) && (defined BUILD_FOR_NORMAL_CLIENT))
...
#if defined(BUILD_FOR_NORMAL_CLIENT)
#define ENABLE_ZOOM_PERFORMANCE_INFO_COLLECTOR
#endif
...
#if  ((defined __MACOS__) || (defined BUILD_FOR_ZPA) || (defined CMM_ANDROID)) && (!defined BUILD_FOR_CLIENT_SDK)
#define ENABLE_DB_KEY_SYNC
#endif

#if (defined CMM_WIN || defined __MACOS__ || defined __LINUX_CLIENT__) && (defined(ZOOM_DEBUG) || defined(BUILD_FOR_DOGFOOD)) && (defined BUILD_FOR_NORMAL_CLIENT || defined BUILD_FOR_VDI)
#define ENABLE_STORAGE_MANAGEMENT
#endif

#if (defined __MACOS__ || defined CMM_WIN) && (defined BUILD_FOR_NORMAL_CLIENT || defined BUILD_FOR_CLIENT_SDK)
#define ENABLE_PHOTOREALISTIC_AVATAR
#endif

#if (defined BUILD_FOR_DOGFOOD || defined ZOOM_DEBUG) && !defined BUILD_FOR_CLIENT_SDK
#define ENABLE_MCP_TOOL
#endif

#if ((defined(CMM_WIN) || defined(__MACOS__) || defined(CMM_ANDROID)) && defined(BUILD_FOR_NORMAL_CLIENT)) 
#define SUPPORT_ONDEMAND_DOWNLOAD_PLUGIN
#endif
