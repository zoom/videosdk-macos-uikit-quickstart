...
public:
    ...
    virtual void OnPairedUSBAudioDeviceDetected(const CmmAudioUSBDeviceBriefInfo& info, CmmBool is_device_found) override;
...
#pragma mark - UniversalUI
    ...
    virtual void CanSupport4KDisplay(CmmBool& can_support) override;
    virtual void OnEnhancedMediaFeatureStatusChanged(CmmBool enable) override;
