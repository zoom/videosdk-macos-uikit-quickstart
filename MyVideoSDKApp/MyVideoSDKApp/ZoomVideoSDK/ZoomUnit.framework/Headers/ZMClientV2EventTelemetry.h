...
- (void)setRawActivityCenterEntity:(ns_zoom_telemetry::ClientV2ActivityCenterEntityParams) activityCenterEntity;
- (void)setRawNavigationBarInfoEntity:(ns_zoom_telemetry::ClientV2NavigationBarInfoEntityParams)navigationBarInfoEntity;
@end
