...
typedef NS_ENUM(NSInteger, ZMShareSelectItemBrowserTabType){
    ZMShareSelectItemBrowserTabType_Chrome,
    ZMShareSelectItemBrowserTabType_Edge,
};
