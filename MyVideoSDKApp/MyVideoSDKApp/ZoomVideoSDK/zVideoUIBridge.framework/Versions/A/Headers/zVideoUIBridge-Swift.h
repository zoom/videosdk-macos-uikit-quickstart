...
#ifndef ZVIDEOUIBRIDGE_SWIFT_H
#define ZVIDEOUIBRIDGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="zVideoUIBridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic) BOOL optimizeVideoShare;
@property (nonatomic) BOOL closedCaption;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL_NAMED("ClipsSharePropertyStatusProtocol")
@protocol ZMMTClipsSharePropertyStatusProtocol <NSObject>
@optional
- (void)currentStatusChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)playTimeChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)totalDurationChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)speedChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)volumeChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)optimizeVideoShareChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
- (void)closedCaptionChanged:(ZMMTClipsSharePropertyModel * _Nonnull)model;
@end


SWIFT_CLASS_NAMED("MediaInfoModel")
@interface ZMMTMediaInfoModel : NSObject
- (nonnull instancetype)initWithTimestamp:(uint64_t)timestamp speed:(CGFloat)speed OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC14zVideoUIBridge13ZMMTVideoMask")
@interface ZMMTVideoMask : NSObject
@property (nonatomic) NSInteger videoBGAlpha;
@property (nonatomic, strong) NSImage * _Nullable videoMaskImage;
@property (nonatomic) CGFloat nameBGAlpha;
@property (nonatomic, readonly) CGContextRef _Nullable videoMaskContext;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
+ (ZMMTVideoMask * _Nonnull)cutoutMask SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
