...
/// Refresh plugin localization bundles after on-demand download completes
/// Call this method after i18n_full.bundle is downloaded and extracted
+ (void)refreshPluginLocalizationBundles;
+ (void)cleanUp;
