...
- (BOOL)isBtnTranscriptNeedShow;
- (BOOL)isAicFeatureStarted;
...
- (void)showHostStartConfirmPanelIfNeed:(ZMMTAICFeatureType)featureType startTranscript:(BOOL)startTranscript;
...
- (BOOL)isZoomIQDisclaimerShowing;
...
- (void)stopTranscription:(BOOL)isRequestedByParticipant requesterUserId:(ZMUserID)requesterUserId deleteAssets:(BOOL)deleteAssets;
